...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `analytics.bigtable.project-id`                                     | The identifier for a Google Cloud Platform project that contains the Cloud Bigtable instance to be used to store analytics data (optional)                                                                                                                               |
| `analytics.bigtable.instance-id`                                    | The identifier for a Cloud Bigtable instance to be used to store analytics data (optional)                                                                                                                                                                               |
...
| `rate-limits.firestore.session-creation.collection-name`            | The name of the Cloud Firestore collection that contains session creation rate limiter "buckets"                                                                                                                                                                         |
| `rate-limits.firestore.session-creation.expiration-field-name`      | The name of the field in documents in the Cloud Firestore collection for session creation rate limit "buckets" that identifies when a bucket is no longer valid (optional)                                                                                               |
| `rate-limits.firestore.session-creation.max-capacity`               | The maximum number of permits in a session creation rate limiter "bucket"                                                                                                                                                                                                |
| `rate-limits.firestore.session-creation.permit-regeneration-period` | The time required for a permit in a session creation rate limiter "bucket" to regenerate                                                                                                                                                                                 |
| `rate-limits.firestore.session-creation.min-delay`                  | The minimum amount of time that must elapse between taking permits from a session creation rate limiter "bucket"                                                                                                                                                         |
